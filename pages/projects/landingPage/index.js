...
import {faAward, faFingerprint, faRetweet, faUserFriends, faRocket, faMedal, faPoll, faLightbulb } from '@fortawesome/free-solid-svg-icons'
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600 text-16px">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <a
                  ...
                  className="font-bold text-gray-800 mt-8 text-16px"
                >
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    ...
                    <p className="text-md font-light mt-2 text-white text-16px">
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-gray-600 text-16px">
                    ...
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-gray-600 text-16px">Amazing page examples</h4>
                        </div>
                      </div>
                    </li>
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-gray-600 text-16px">Dynamic components</h4>
                        </div>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    alt="..."
                    src="/images/projects/landingPage/team-1-800x800.jpg"
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <div className="mt-6">
                      ...
                      <button
                        className="bg-pink-500 text-white w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button"
                      >
                        <i className="fab fa-dribbble"></i>
                        <FontAwesomeIcon icon={faDribbble} className={styles.fabIcon}/>
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    ...
                    src="/images/projects/landingPage/team-2-800x800.jpg"
                    className="shadow-lg rounded-full max-w-full mx-auto"
                    style={{ maxWidth: "120px" }}
                  />
                  <div className="pt-6 text-center">
                    ...
                    <div className="mt-6">
                      <button
                        className="bg-red-600 text-white w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button"
                      >
                        <FontAwesomeIcon icon={faGoogle} className={styles.fabIcon}/>
                      </button>
                      <button
                        className="bg-blue-600 text-white w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button"
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    ...
                    src="/images/projects/landingPage/team-3-800x800.jpg"
                    className="shadow-lg rounded-full max-w-full mx-auto"
                    style={{ maxWidth: "120px" }}
                  />
                  <div className="pt-6 text-center">
                    ...
                    <div className="mt-6">
                      ...
                      <button
                        className="bg-gray-800 text-white w-10 h-10 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button"
                      >
                        <FontAwesomeIcon icon={faInstagram} className={styles.fabIcon}/>
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  <img
                    ...
                    src="/images/projects/landingPage/team-4-470x470.png"
                    className="shadow-lg rounded-full max-w-full mx-auto"
                    style={{ maxWidth: "120px" }}
                  />
                  <div className="pt-6 text-center">
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      <label
                        className="block uppercase text-gray-700 text-xs font-bold mb-2 text-sm"
                        htmlFor="full-name"
                      >
                        Full Name
                      </label>
